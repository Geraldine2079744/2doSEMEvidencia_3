...
Contactos.append(Contacto('Maestro','José Ruiz','jose.ruiz@hotmail.com'))
Contactos.append(Contacto('Estudiante','Alma Pérez','almitarules@hotmail.com'))
Contactos.append(Contacto('Estudiante','Pedro Gonzalez','pedro@hotmail.com'))
